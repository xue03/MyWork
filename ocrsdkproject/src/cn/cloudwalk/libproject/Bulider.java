...
public class Bulider {
	...
	public static BankOcrResultCallback mBankOcrResultCallback;
	public static IDCardOcrResultCallback mIdCardOcrResultCallback;
	 ...
	 * @return
	 */
	public Bulider setBankOCRFinished(BankOcrResultCallback bankOcrResultCallback) {
		Bulider.mBankOcrResultCallback = bankOcrResultCallback;
		return this;
	}
	/**
	 * 身份证结果完成回调
	 * @return
	 */
	public Bulider setIDCardOCRFinished(IDCardOcrResultCallback idCardOcrResultCallback) {
		Bulider.mIdCardOcrResultCallback = idCardOcrResultCallback;
		return this;
	}
	/**
	 * 人脸后端验证
