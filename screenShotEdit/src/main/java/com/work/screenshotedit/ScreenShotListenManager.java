...
public class ScreenShotListenManager {
    ...
    private ScreenShotListenManager(Context context) {
        ...
        if (sScreenRealSize == null) {
            ...
            if (sScreenRealSize != null) {
                Log.d("TAG", "ScreenShotListenManager: "+"Screen Real Size: " + sScreenRealSize.x + " * " + sScreenRealSize.y);
            } else {
                Log.d("TAG", "ScreenShotListenManager: Get screen real size failed.");
            }
        }
    }
...
//                LogUtils.e("Cursor no data.");
    ...
    private void handleMediaRowData(String data, long dateTaken, int width, int height) {
        Log.d("TAG", "handleMediaRowData: "+"ScreenShot: path --- " + data + "; size = " + width + " * " + height
                + "; date = " + dateTaken);
        if (checkScreenShot(data, dateTaken, width, height)) {
            ...
            Log.d("TAG", "handleMediaRowData: "+"Media content changed, but not screenshot: path = " + data
